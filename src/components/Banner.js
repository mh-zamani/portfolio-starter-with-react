  ...
  <section className='min-h-[85vh] lg:min-h-[78vh] flex items-center ' id='home'>
   ...
   <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12'>
      ...
      <div className='flex-1 text-center font-secondary lg:text-left ' >
        ...
        variants={fadeIn('up' , 0.3)}
         ...
         whileInView={'show'}
          viewport={{once: false , amount :0.7}}
           className='text-[50px] font-bold leading-[0.5] lg:text-[50px] mb-3'>
          Mh 
          <span>Zamani</span>
        </motion.h1>
        ...
        whileInView={'show'}
         viewport={{once: false , amount :0.7}}
        className='flex max-w-max gap-x-6 items-canter mb-12 mx-auto lg:mx-0'>
        <button className='btn btn-lg'> Contact us </button>
        <a href='#' className='text-gradient btn-link mt-4'> My protfolio </a>
        </motion.div>
      ...
      <motion.div 
       ...
       whileInView={'show'}
        viewport={{once: false , amount :0.7}}
      className='flex text-[18px] gap-x-2 max-w-max max-auto lg:mx-0 '>
        <a href='#'>
        <FaGithub />
        </a>
        <a href='#'>
      ...
      <motion.div 
       ...
       initial="hidden" 
       whileInView={'show'}
      className='hidden lg:flex flex-1 max-w-[320px] lg:max-w-[330px]'>
        <img src={Image}></img>
      </motion.div>
